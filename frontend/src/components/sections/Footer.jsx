    ...
    <footer className="bg-black pt-20 pb-6 border-t border-white/10 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row justify-between items-center gap-6">
        <div className="flex gap-8">
          ...
          <a href="https://www.linkedin.com/in/arman-somani" target="_blank" rel="noreferrer" className="text-white/50 hover:text-white font-sans text-xs uppercase tracking-widest transition-colors hover-underline">LinkedIn</a>
