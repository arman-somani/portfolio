...
const Projects = () => {
  const projects = [
    ...
    { _id: '2', title: 'CareSignal AI (UNDER-DEVELOPMENT)', description: 'A comprehensive AI-powered health and wellness platform for patient monitoring.', image: '/caresignal_custom.png', technologies: ['React', 'Next.js', 'Tailwind', 'Node.js', 'MongoDB', 'Vercel', 'OpenAI', 'Framer Motion'], url: 'https://mycaresignal.vercel.app' },
  ];
  const loading = false;
